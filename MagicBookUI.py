...
def createUI():
    ...
    cmds.button(label='AutoGuides',command='MBFuncs.autoGuides()')
    cmds.button(label='AutoMiddles', command='MBFuncs.autoMiddles()')
    ...
    roughness = cmds.floatFieldGrp(label="roughness = ", value1=0.7, adjustableColumn2=2)
    ...
    cmds.button(label="Execute",
                command=lambda *args: MBFuncs.assignPageShader(
                    ...
                    cmds.floatFieldGrp(roughness, query=True, value1=True),
